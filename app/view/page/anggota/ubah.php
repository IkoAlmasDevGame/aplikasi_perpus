        ...
        <div class="panel container panel-default bg-body-secondary">
            <div class="panel-body">
                ...
                <div class="d-flex justify-content-end align-items-end flex-wrap mx-2">
                    ...
                    <li class="breadcrumb breadcrumb-item">
                        <a href="?aksi=ubah-anggota&id=<?php echo $_GET['id']?>" aria-current="page"
                ...
                <div class="container">
                    <div class="table-responsive">
                        ...
                        <?php 
                            ...
                            $data = $konfigs->query("SELECT * FROM anggota WHERE id_anggota = '$id'");
                                            ...
                                            <div class="form-inline row justify-content-center align-items-center">
                                                ...
                                                <div class="col-sm-6 col-sm-7">
                                                    <input type="text" name="nim" maxlength="11"
                                                        value="<?php echo $isi['nim']?>" class="form-control"
                                            ...
                                            <div class="form-inline row justify-content-center align-items-center">
                                                ...
                                                <div class="col-sm-6 col-sm-7">
                                                    <input type="text" name="nama_anggota"
                                                        value="<?php echo $isi['nama_anggota']?>" maxlength="100"
                                            ...
                                            <div class="form-inline row justify-content-center align-items-center">
                                                ...
                                                <div class="col-sm-6 col-sm-7">
                                                    <input type="text" name="tempat_lahir" maxlength="255"
                                                        class="form-control" value="<?php echo $isi['tempat_lahir']?>"
                                            ...
                                            <div class="form-inline row justify-content-center align-items-center">
                                                ...
                                                <div class="col-sm-6 col-sm-7">
                                                    <input type="date" name="tanggal_lahir" maxlength=""
                                                        class="form-control" value="<?php echo $isi['tanggal_lahir']?>"
                                            ...
                                            <div class="form-inline row justify-content-center align-items-center">
                                                ...
                                                <div class="col-sm-6 col-sm-7">
                                                    <select name="jenis_kelamin" required aria-required="TRUE"
                                                        ...
                                                        <option value="L" <?php if($isi['jenis_kelamin'] == 'L'){?>
                                                            selected <?php } ?>>
                                                            Laki
                                                            - Laki</option>
                                                        <option value="P" <?php if($isi['jenis_kelamin'] == 'P'){?>
                                                            selected <?php } ?>>
                                                            Perempuan</option>
                                                    </select>
                                                </div>
                                            ...
                                            <div class="form-inline row justify-content-center align-items-center">
                                                ...
                                                <div class="col-sm-6 col-sm-7">
                                                    <input type="text" name="prodi_kuliah" maxlength="80"
                                                        class="form-control" value="<?php echo $isi['prodi_kuliah']?>"
