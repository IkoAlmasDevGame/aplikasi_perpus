        ...
        <div class="panel container panel-default bg-body-secondary">
            <div class="panel-body">
                ...
                <div class="d-flex justify-content-end align-items-end flex-wrap mx-2">
                    ...
                    <li class="breadcrumb breadcrumb-item">
                        <a href="?aksi=daftar-buku" aria-current="page"
                                        ...
                                        <div class="form-inline row justify-content-center align-items-center">
                                            ...
                                            <div class="col-sm-6 col-md-7">
                                                <input type="text" name="number1"
                                                    class="col-sm-2 col-md-2 border rounded-1 text-center" maxlength="3"
                                                    required aria-required="TRUE" id=""> -
                                                <input type="text" name="number2" maxlength="5"
                                                    class="col-sm-2 col-md-2 border rounded-1 text-center" required
                                                    aria-required="TRUE" id=""> -
                                                <input type="text" name="number3" maxlength="5"
                                                    class="col-sm-2 col-md-2 border rounded-1 text-center" required
                                                    aria-required="TRUE" id=""> -
                                                <input type="text" name="number4" maxlength="5"
                                                    class="col-sm-2 col-md-2 border rounded-1 text-center" required
                                                    aria-required="TRUE" id=""> -
                                                <input type="text" name="number5" maxlength="5"
                                                    class="col-sm-2 col-md-2 border rounded-1 text-center" required
                                                    aria-required="TRUE" id="">
                                        ...
                                        <div class="form-inline row justify-content-center align-items-center">
                                            ...
                                            <div class="col-sm-6 col-md-7">
                                                ...
                                                <input type="date" name="tanggal_input" readonly
                                                    class="form-control date-formate" value="<?php echo $date; ?>"
                                                    required aria-required="TRUE" id="">
                                            </div>
                                        </div>
                                    </div>
