    ...
    <body class="body" onload="startTime()">
        <nav class="navbar navbar-default navbar-expand-lg bg-body-tertiary">
            <div class="container-fluid">
                <a href="index.php" aria-current="page" class="navbar-brand">Aplikasi Perpustakaan</a>
            </div>
        </nav>
            ...
            <div class="d-flex justify-content-center align-items-center flex-wrap mt-1 pt-1">
                <div class="card shadow mb-4">
                    <div class="card-header py-2">
                        <h4 class="card-title text-center">Login - Aplikasi Perpustakaan -</h4>
                    </div>
                    <div class="card-body mt-1">
                        ...
                        <?php 
                            ...
                            $auth = new controller\Authentication($konfigs);
                            if(!isset($_GET['aksi'])){
                            }else{
                                switch ($_GET['aksi']) {
                                    case 'login':
